...
export default function Hero() {
  return (
    <>
      ...
      <section
        id="hero"
        className="relative min-h-screen w-full overflow-hidden pb-0 mb-0"
        style={{
      ...
      >
        ...
        {/* Top tagline - improved mobile font size */}
        <motion.p
          className="pointer-events-none absolute top-4 sm:top-6 md:top-8 left-1/2 -translate-x-1/2 text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px] tracking-[0.2em] sm:tracking-[0.25em] md:tracking-[0.3em] uppercase text-white/90 z-30 text-center px-3 sm:px-4"
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <motion.img
            ...
            alt=""
            className="absolute left-[2%] sm:left-[8%] md:left-[10%] top-[40%] -translate-y-1/2 w-[100px] sm:w-[140px] md:w-[200px] lg:w-[300px] opacity-90"
          ...
          <motion.img
            src="https://cdn.prod.website-files.com/6694f91706f861444dd250c0/66952e8fa9955d9d2b113df9_realistic-coffee-bean%201.svg"
            alt=""
            className="absolute right-[0%] sm:right-[5%] md:right-[8%] top-[40%] -translate-y-1/2 w-[120px] sm:w-[180px] md:w-[280px] lg:w-[400px] opacity-90"
        ...
        <div className="relative z-20 flex flex-col justify-center min-h-screen px-4 sm:px-6 md:px-10 lg:px-16 pb-0 sm:pb-12">
          <div className="overflow-hidden mb-3 sm:mb-6 md:mb-8 lg:mb-10 mt-12 sm:mt-14 md:mt-20 lg:mt-24 text-center">
            ...
            <motion.h1
              className="text-white leading-none -mt-3 sm:-mt-4 md:-mt-6"
              style={{
                fontFamily: "'Bebas Neue', 'Arial Black', sans-serif",
                fontSize: 'clamp(4rem, 15vw, 10rem)',
                fontWeight: 900,
          ...
          >
            <p className="text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] leading-relaxed font-mono">
            ...
            <p className="text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] leading-relaxed font-mono font-semibold">
